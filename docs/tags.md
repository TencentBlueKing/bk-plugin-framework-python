...
- [Tag 使用说明](#1-Tag使用说明)
- [Tag 组件属性、方法](#2-Tag组件属性、方法)
    - [公共属性](#21-公共属性)
    - [公共方法](#22-公共方法)
    - [官方 Tag 组件说明](#23-官方Tag组件说明)
        - [TagButton](#231-TagButton)
        - [TagCascader](#232-TagCascader)
        - [TagCheckbox](#233-TagCheckbox)
        - [TagDatatable](#234-TagDatatable)
        - [TagDatetime](#235-TagDatetime)
        - [TagTime](#236-TagTime)
        ...
        - [TagTextarea](#2314-TagTextarea)
        - [TagTree](#2315-TagTree)
...
- [Tag 组件间的事件交互](#4-Tag组件间的事件交互)

<!-- /TOC -->



<a id="toc_anchor" name="#1-Tag使用说明"></a>

# Tag 使用说明

Tag 为表单项的最小单元，它的使用非常简单，只需要在标准插件配置项中定义好 `type` 字段，传入该类 Tag 支持的属性和方法即可在前端页面渲染出对应的表单项，通过 Tag 组件之间的组合，也可以构造出复杂的表单交互。

`type`字段标识了所需要渲染表单项的类型，例如`input`表示输入框，`datetime`表示日期时间选择框，目前官方内置的表单类型有：
...
- TagSection
- codeEditor
<a id="toc_anchor" name="#2-Tag组件属性、方法"></a>
...
<a id="toc_anchor" name="#21-公共属性"></a>
...
<a id="toc_anchor" name="#22-公共方法"></a>
...
<a id="toc_anchor" name="#23-官方Tag组件说明"></a>

## 官方 Tag 组件说明

<a id="toc_anchor" name="#231-TagButton"></a>
...
<a id="toc_anchor" name="#232-TagCascader"></a>
...
<a id="toc_anchor" name="#233-TagCheckbox"></a>
...
<a id="toc_anchor" name="#234-TagDatatable"></a>
...
<a id="toc_anchor" name="#235-TagDatetime"></a>
...
<a id="toc_anchor" name="#236-TagTime"></a>
...
<a id="toc_anchor" name="#237-TagInput"></a>
...
<a id="toc_anchor" name="#238-TagInt"></a>
...
<a id="toc_anchor" name="#2312-TagSelect"></a>
...
<a id="toc_anchor" name="#2313-TagText"></a>
...
<a id="toc_anchor" name="#2314-TagTextarea"></a>
...
<a id="toc_anchor" name="#2315-TagTree"></a>
...
<a id="toc_anchor" name="#2316-TagUpload"></a>
...
<a id="toc_anchor" name="#2317-TagMemberSelector"></a>
...
<a id="toc_anchor" name="#2318-TagLogDisplay"></a>
...
<a id="toc_anchor" name="#2320-TagSection"></a>
...
<a id="toc_anchor" name="#2321-TagCodeEditor"></a>
...
<a id="toc_anchor" name="#3-标准插件中定义的方法"></a>
...
<a id="toc_anchor" name="#4-Tag组件间的事件交互"></a>
